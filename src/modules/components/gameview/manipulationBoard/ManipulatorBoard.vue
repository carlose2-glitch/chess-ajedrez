<template>
  <div
    v-for="p in data.paintings"
    v-bind:class="p.classs"
    @click="movementPiece(p.left, p.top)"
    v-bind:key="p.left"
  ></div>
</template>

<script lang="ts" setup>
import type { Measures } from '@/modules/interfaces/gamefuntions/pieces.interface';
